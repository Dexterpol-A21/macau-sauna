...
const chipOn =
  "rounded-full px-3 py-1.5 text-[13px] font-bold transition-colors bg-gradient-to-r from-[var(--color-primary-light)] to-[var(--color-primary-dark)] text-black";
...
export default function QuickMatch() {
  ...
  return (
    <section id="quickmatch" className="scroll-mt-6 px-4 pb-20 sm:pb-28">
      <div className="qm-root mx-auto max-w-5xl rounded-3xl border border-[color-mix(in_srgb,var(--color-primary)_25%,transparent)] bg-gradient-to-b from-[color-mix(in_srgb,var(--color-primary)_7%,transparent)] to-white/[0.02] p-5 sm:p-8">
        <div className="mb-6 text-center sm:mb-8">
          ...
          <p className="mx-auto mt-3 max-w-xl text-balance text-sm text-white/55 sm:text-base">
            ...
            <div>
              ...
              <div className="qm-hero relative overflow-hidden rounded-2xl border border-[color-mix(in_srgb,var(--color-primary)_40%,transparent)] bg-black/40">
                <div className="relative h-44 w-full overflow-hidden sm:h-52">
                  ...
                  <span className="absolute left-3 top-3 rounded-md bg-gradient-to-br from-[var(--color-primary-light)] to-[var(--color-primary-dark)] px-2.5 py-1 text-[11px] font-black tracking-wider text-black shadow">
                    BEST MATCH
                  </span>
                  <span className="absolute right-3 top-3 rounded-md bg-black/55 px-2.5 py-1 text-sm font-extrabold text-[var(--color-primary)] backdrop-blur-sm">
                    {best.score}% match
                  </span>
