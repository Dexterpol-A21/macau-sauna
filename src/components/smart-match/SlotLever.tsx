    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          background: "linear-gradient(180deg, #C41E3A, #FF2D55, #FF6B85)",
          opacity: rodOpacity,
        }}
      />
      ...
      >
        <motion.div
          ...
          style={{
            ...
            marginTop: -20,
            background:
              "radial-gradient(circle at 35% 30%, #A8F5DC 0%, #FF6B85 20%, #FF2D55 50%, #C41E3A 90%, #0A5C55 100%)",
            boxShadow: useTransform(
              knobGlow,
              (v) =>
                `0 0 ${20 * v}px rgba(255,45,85,${0.55 * v}), inset 0 1px 0 rgba(255,255,255,0.3)`,
            ),
          }}
        />
      </motion.div>
